 ...
 * @returns {Object} Selectors - Contains matcherTargetSelector (string|null) and matcherParentSelector (string|null)
 */
...
async function checkShowingMatcher(page, matcherTargetSelector, matcherParentSelector) {
    ...
    return await page.evaluate((targetSel, parentSel) => {
        ...
        //If the matched element is a Shadow Host, its visibility cannot be reliably
        //assessed via computedStyle or getBoundingClientRect(). The host itself most of the time
        //has no visible dimensions; all rendered content lives inside the Shadow DOM.
        //Return null to signal "not assessable" rather than a false negative.
        //Could potentially be fixed by complexe DOM traversal
